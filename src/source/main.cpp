...
private:
  ...
  void createTextureSampler()
  {
    ...
    // Can query this at beginning and hold it for now, or just query it here. No big deal unless we do this many many times
  ...
  void createDescriptorSets()
  {
    ...
    std::cout << "Successfully allocated descriptor sets!\n";
    ...
    std::cout << "Successfully updated descriptor sets!\n";
  }
  ...
  void createSyncObjects()
  {
    ...
    for (size_t i = 0; i < MaxFramesInFlight; ++i)
    {
      ...
      std::cout << "Successfully created synchronization objects for frame " << i + 1 << " of " << MaxFramesInFlight <<"!\n";
    }
  }
